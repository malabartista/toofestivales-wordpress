...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  <tr>
    <td width="100" valign="top"><strong><a style="text-decoration: none" href="javascript:gdsrShowHidePreview('<?php echo $this->get_field_id('div_stars'); ?>')"><?php _e("Graphics", "gd-star-rating"); ?></a></strong></td>
...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td align="right"><select style="width: 200px" name="<?php echo $this->get_field_name('rating_thumb'); ?>"><?php GDSRHelper::render_styles_select($wptt, $instance['rating_thumb']); ?></select></td>
  </tr>
  <tr>
    <td width="100" valign="top"></td>
    <td width="100" nowrap="nowrap"><?php _e("Thumbs Size", "gd-star-rating"); ?>:</td>
    <td align="right"><?php GDSRHelper::render_thumbs_sizes($this->get_field_name('rating_thumb_size'), $instance['rating_thumb_size'], 200); ?></td>
  </tr>
</table>
</div>
