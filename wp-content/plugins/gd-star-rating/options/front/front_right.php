    ...
    <div class="inside">
        ...
        <div class="table">
            <table><tbody>
                ...
                <tr>
                    <td class="first b" style="width: 133px;"><?php _e("Code Name", "gd-star-rating"); ?></td>
        ...
        <div class="table">
            <table><tbody>
                ...
                <tr>
                    <td class="first b">Google Code</td>
                    <td class="t"><?php _e("development home with svn", "gd-star-rating"); ?></td>
        ...
        <p class="sub"><?php _e("Support", "gd-star-rating"); ?></p>
        <div class="table">
            <table><tbody>
                <tr class="first">
        ...
        <div class="table">
            <table><tbody>
                <tr class="first">
                    ...
                    <td class="t"><?php _e("premium wordpress plugins and themes", "gd-star-rating"); ?></td>
