<?php
/**
Plugin Name: Couchsurfing API
Description: Couchsurfing API allows you to connect to Couchsurfing Rest Api to get information.
Version: 1.0
Author: Luis Rodriguez
License: GPLv2 or later
Text Domain: couchsurfing
*/
defined( 'ABSPATH' ) or die( 'No script kiddies please!' );
function couchsurfing_func( $atts ) {
  ...
  foreach ($response->conversations as $conversation){
    $return .= "<img width='50' src='" . $conversation->withUser->avatarUrl . "'>" . $conversation->withUser->publicName . "</br></br>";  
  }
  */
  return $return;
}
add_shortcode( "couchsurfing", "couchsurfing_func" );
