...
* Changed: At least WordPress 3.6 is required to meet the minimum jQuery 1.10.2 requirement.
...
= 1.3.7 =
* Fixed : Adjusted shortcode substitute to NextGen shortcode handler to make [nggallery] rendering through WunderSlider work again.
...
= 1.3.9 =
* PLEASE READ the changelog before updating! There are IMPORTANT changes. WordPress 3.7.1 compatibility tested and allowing custom skins. From this version on, at least WordPress 3.6 is required and the WunderSlider plugin 1.1.0 or above must be used.

= 1.3.8 =
* Added an option to link images in galleries displayed with the [gallery] shortcode to themselves (so you can click an image displayed in the WunderSlider and get to the full image). Usage: [gallery linkurls="true" useflick="false" clickable="true"]

= 1.3.7 =
* Fixed issues with [nggallery] rendering through WunderSlider not working in latest versions of NextGen.

= 1.3.6 =
* Fixes issues with NextGEN 2.x; WordPress 3.6 compatibility checked.
