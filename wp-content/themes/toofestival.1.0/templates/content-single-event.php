                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="blockquote-box blockquote-artists clearfix">
                            ...
                            <h4>Artistas</h4>
                            <div itemscope itemprop="performer" itemtype="http://schema.org/Person">
                                <p>
                  ...
                  <?php
                      ...
                      if ( function_exists( 'em_init' ) ) {
                          ...
                          if ( em_is_event_page() ) { // single event conditional
                            $this_page = '<a href="'.site_url().'" rel="v:url" property="v:title">'.$bc_home.'</a> '.$bc_sep.'<span rel="v:child" typeof="v:Breadcrumb"><a href="http://toofestival.es/festivales" rel="v:url" property="v:title">Festivales 2016</a></span>'.$bc_sep.' &nbsp;&nbsp;&nbsp;<strong>'.$EM_Event->output('#_NAME').'</strong>';
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div id="festival-cartel" style="margin-bottom:20px">
                            <a id="cartel_image" href="<?php echo $poster; ?>"><img class="aligncenter size-full" src="<?php echo $poster; ?>" alt="Cartel <?php the_title(); ?>"></a>
                        </div>
                        <?php } ?>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("a#cartel_image").fancybox();
