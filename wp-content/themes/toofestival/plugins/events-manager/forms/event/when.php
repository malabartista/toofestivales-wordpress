...
<div class="event-form-when" id="em-form-when">
	<p class="em-date-range">
		<label><?php _e ( 'From ', 'events-manager'); ?></label>					
		...
		<label><?php _e('to','events-manager'); ?></label>
	...
	<p class="em-time-range">
		<label><span class="em-event-text"><?php _e('Event starts at','events-manager'); ?></span></label>
