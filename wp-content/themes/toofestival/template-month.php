...
<?php
    ...
    $month_path = explode("/", $path);
    $month = $month_path[2];
    if($month=='junio'){
    	$scope = '2017-06-01,2017-06-30';
    } else if($month=='julio'){
    	$scope = '2017-07-01,2017-07-31';
    } else if($month=='agosto'){
    	$scope = '2017-08-01,2017-08-31';
    } else if($month=='septiembre'){
    	$scope = '2017-09-01,2017-09-30';
    }
?>
<div id="page-title">
    <!-- The Map -->
...
<form id="td-filter-listings" type="get" action="http://toofestival.es/calendario-festivales/">
    <div id="">
                                    ...
                                    <div class="filter-by-tag-holder">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6" style="float: right;">
                                                ...
                                                <button class="td-buttom reset-country reset-category" id="reset-filter" name="submit" type="submit" style="margin-bottom: 0!important"><i class="fa fa-times"></i>Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
