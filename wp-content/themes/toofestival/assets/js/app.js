...
jQuery(document).ready(function($) {
    ...
    $('.back-to-top').click(function () {
        $('html, body').scrollTo($('#scroll-top-anchor'), 300);
    });
    ...
    $("#page-title.event-page-title").each(function() {
        if($(window).height() > 460) {
            $("#page-title.event-page-title .container .row .col-sm-4 .event-header-container").css("height", $(window).height() - $("#header").height());
        } else {
            $("#page-title.event-page-title .container .row .col-sm-4 .event-header-container").css("height", 500);
        }
    });
    ...
    $(document).bind('em_maps_locations_hook', function( e, map, infowindow, marker,maps_markers){
        ...
        */
        ...
        var markerCluster = new MarkerClusterer(map, maps_markers);

        jQuery("#map-canvas-shadow").css("display","none");
        //jQuery(".map-pins-total").html(maps_markers.length);
        //jQuery(".pins-total").html(maps_markers.length);
        //jQuery(".pins-load").addClass("hide");
        //map.setCenter(new google.maps.LatLng(28.70, -127.50));
    });
    $('.em-location-map-container').css("width", "100%");
    $('#festivales-map .em-location-map-container').removeClass("thumbnail");
