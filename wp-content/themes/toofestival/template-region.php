...
<?php
    ...
    $region = ucfirst($country_path[4]);
?>
<div id="page-title">
    <!-- The Map -->
    <div id="map-canvas-holder">
        <div id="map-script-holder" class="map-canvas">
            <?php echo do_shortcode('[locations_map category="' . $category . '" country="' . $country . '" region="' . $region . '" scope="' . $scope . '" search="' . $search . '" limit=500]'); ?>
        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="item-block-title">
                            ...
                            <span class="page-title-aright">
                                ...
                                <span class="pins-total"><?php echo EM_Events::count(array("scope" => $scope, "category" => $category, "country" => $country, "region" => $region, "search" => $search));?></span> Festivales encontrados
                            </span>
                        </div>
    ...
    <div class="container box">
        <div id="events-result">
            ...
            <div id="cat-listing-holder">
                <?php echo do_shortcode('[events_list category="' . $category . '" country="' . $country . '" region="' . $region . '" scope="' . $scope . '" search="' . $search . '" page="' . $_GET["my_listings_current_page"] . '" pagination=1 ]'); ?>
            </div>
        </div>
    </div>
