...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.theme.css', false, null);
  ...
  wp_register_script('addevent', '//addevent.com/libs/atc/1.6.1/atc.min.js', false, null, true);
  ...
  wp_register_script('skrollr', get_template_directory_uri() . '/assets/js/skrollr.js', false, null, true);
  ...
  wp_register_script('markerclusterer', get_template_directory_uri() . '/assets/js/markerclusterer.min.js', false, null, true);
  wp_register_script('flexslider', get_template_directory_uri() . '/assets/js/jquery.flexslider.min.js', false, null, true);
  wp_register_script('jquery-form', get_template_directory_uri() . '/assets/js/jquery.form.min.js', false, null, true);
  wp_register_script('app_script', get_template_directory_uri() . '/assets/js/app.js', false, null, true);
